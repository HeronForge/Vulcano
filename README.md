...
Part of the HeronForge family; shared conventions and cross-project checkpoints live in the
sibling repo `heronforge-kb` (see `CLAUDE.md`).

## Status

Scaffolding only. Architecture, tech stack and feature scope are not decided yet.
